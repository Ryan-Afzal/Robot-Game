...
namespace Assets.Scripts.Scripting.Block {
	public abstract class BlockArgument : MonoBehaviour, IBeginDragHandler, IDragHandler, IEndDragHandler, IHierarchyChangeHandler {
        ...
        public abstract IArgInstruction GetCompiledInstruction();
